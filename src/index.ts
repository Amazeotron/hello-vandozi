import { fetchBrowserQL, surfConditions } from "@src/routes/surf-conditions.js";
...
async function resultfetchBrowserQL() {
  const result = await fetchBrowserQL();
  console.log("Result from fetchBrowserQL:", result);
}
resultfetchBrowserQL();
